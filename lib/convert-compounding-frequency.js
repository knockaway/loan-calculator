 ...
 */
export function convertCompoundingFrequency({ interestRate, oldCompoundingFrequency, newCompoundingFrequency }) {
  return (
    newCompoundingFrequency *
    (Math.pow(1 + interestRate / oldCompoundingFrequency, oldCompoundingFrequency / newCompoundingFrequency) - 1)
  );
}
